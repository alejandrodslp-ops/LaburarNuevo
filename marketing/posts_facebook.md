# Posts de Facebook — listos para publicar

> ⚠️ Antes de publicar: pedirle a Claude que REFRESQUE los números contra la base
> (vagas por oficio cambian a diario). Los de abajo son del 12/07/2026.

## BRASIL — Post 1: "La matemática que nadie te cuenta" (grupos masivos generales)

Tem 97 mil vagas abertas no Brasil agora mesmo. Então por que é tão difícil achar a sua?
...
## BRASIL — Post 2: "La historia + la lista" (3-4 días después / grupos de oficios)

Ontem às 22h um usuário se cadastrou no site. Hoje de manhã acordou com 5 vagas da área dele no email. Não fez busca nenhuma. Só escreveu o que sabe fazer: "higiene e segurança".

É assim que deveria funcionar pra todo mundo. Olha o que tem aberto agora no Brasil:

🛒 Vendas e comercial: 15.924 vagas
🏭 Auxiliar (produção, limpeza, depósito...): 10.586
☎️ Atendimento: 3.086
💉 Enfermagem: 1.627
🛡️ Segurança: 1.268
...
No es que no busques — es que están desparramados: ONSC por un lado, las intendencias por otro, ASSE, ANEP, UdelaR… y cuando alguien te avisa, ya fue.
...
- Post 1 y Post 2 nunca el mismo día en el mismo grupo (separar 3-4 días).
- Responder los comentarios el primer día (el algoritmo premia conversación).
- Cuando alguien comente un oficio: pedirle los números reales a Claude y responder con el dato exacto.
- Cuenta personal real, no cuenta nueva (las cuentas nuevas publicando links = ban).
