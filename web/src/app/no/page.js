...
export const metadata = {
  ...
  alternates: { canonical: '/no', languages: { 'es': '/', 'es-ES': '/es-es', 'pt-BR': '/pt', 'en': '/en', 'fr': '/fr', 'it': '/it', 'de': '/de', 'sv': '/sv', 'no': '/no', 'ja': '/ja' } },
  openGraph: { title: t.og_title, description: t.og_desc, url: '/no', siteName: 'Konexu', locale: t.locale, type: 'website', images: [{ url: '/og-konexu-no.png', width: 1200, height: 630 }] },
  twitter: { card: 'summary_large_image', title: t.og_title, description: t.og_desc, images: ['/og-konexu-no.png'] },
