...
export default function RegisterEmpresaScreen({navigation}){
  ...
  async function handleRegistrar(){
    ...
    if(rut.trim().length<2){Alert.alert("Error","Ingresa el RUT o identificacion fiscal");return;}
  ...
  return(
    <SafeAreaView style={ss.c} edges={["top"]}>
      <KeyboardAwareScrollView contentContainerStyle={ss.scroll} keyboardShouldPersistTaps="handled" enableOnAndroid={true} extraScrollHeight={120}>
        <View style={ss.hdr}>
        ...
        <View style={ss.sec}>
          ...
          <View style={ss.iw}>
            ...
            <View style={ss.ib}><TextInput style={ss.input} placeholder="Ej: 21234567-8" placeholderTextColor="#D0C8DC" value={rut} onChangeText={setRut} autoCapitalize="none"/></View>
          </View>
          <View style={ss.iw}>
